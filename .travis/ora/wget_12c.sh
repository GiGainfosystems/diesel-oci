...
echo "Created temporary cookie file $COOKIE_FILE"
...
# 
 $WGET  --secure-protocol=auto --save-cookies="$COOKIE_FILE" --keep-session-cookies --http-user "$SSO_USERNAME" --http-password "$SSO_PWD"  "https://edelivery.oracle.com/osdc/cliauth" -O /dev/null
...
then 
 ...
 echo "Authentication is successful. Proceeding with downloads..." 
